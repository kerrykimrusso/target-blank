...
const ChildListChange = (function () {
...
const TreeChanges = (function (_super) {
...
const MutationProjection = (function () {
  // TOOD(any)
...
const MutationSummary = (function () {
  ...
  MutationSummary.createObserverOptions = function (queries) {
    ...
    queries.forEach((query) => {
      ...
      let attributes = elementFilterAttributes(query.elementFilter).concat(query.attributeList || []);
  ...
  MutationSummary.prototype.changesToReport = function (summaries) {
    return summaries.some((summary) => {
      let summaryProps = ['added', 'removed', 'reordered', 'reparented',
        'valueChanged', 'characterDataChanged'];
      if (summaryProps.some((prop) => { return summary[prop] && summary[prop].length; }))
        {return true;}
